...
extern int init_eink_ctrl_data_8(unsigned int wavedata_buf, struct eink_timing_param *eink_timing_info, unsigned int i);
extern int init_eink_ctrl_data_16(unsigned int wavedata_buf, struct eink_timing_param *eink_timing_info);
#endif
